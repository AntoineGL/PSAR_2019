...
echo "Test 5/12: File: ${prefix}DC1_read1_gap5_${occ}occ.csv"
./benchmark_nb_pages.sh "gap=5" $occ 1024 1 $file ${prefix}DC1_read1_gap5_${occ}occ.csv
...
echo "Test 6/12: File: ${prefix}DC0_read1_sequential_${occ}occ.csv"
./benchmark_nb_pages.sh sequential $occ 1024 1 $file ${prefix}DC0_read1_sequential_${occ}occ.csv

echo "Test 7/12: File: ${prefix}DC0_read1_gap1_${occ}occ.csv"
./benchmark_nb_pages.sh "gap=1" $occ 1024 1 $file ${prefix}DC0_read1_gap1_${occ}occ.csv

echo "Test 8/12: File: ${prefix}DC0_read2_gap1_${occ}occ.csv"
./benchmark_nb_pages.sh "gap=1" $occ 1024 2 $file ${prefix}DC0_read2_gap1_${occ}occ.csv

echo "Test 9/12: File: ${prefix}DC0_read1_gap5_${occ}occ.csv"
./benchmark_nb_pages.sh "gap=5" $occ 1024 1 $file ${prefix}DC0_read1_gap5_${occ}occ.csv
